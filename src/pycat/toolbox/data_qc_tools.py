...
# ── check families moved to data_qc/<family>.py (data_qc_decomposition) — re-exported so run_full_qc
#    and external callers (dashboard/gallery/quality-gate/reliability-index) resolve them ──────────
from pycat.toolbox.data_qc.exposure import (  # noqa: F401
    qc_saturation)
...
from pycat.toolbox.data_qc.noise import (  # noqa: F401
    qc_snr)
from pycat.toolbox.data_qc.sampling import (  # noqa: F401
    qc_nyquist, qc_time_sampling)

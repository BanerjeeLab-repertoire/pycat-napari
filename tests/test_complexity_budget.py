...
_FILE_LINE_CEILINGS = {
    # 2669 -> 2515: the automatic object-size estimators split into toolbox/image_processing/
    # size_estimation.py (image_processing decomposition step 1, 1.6.248, characterization-first). A NEW
    # ceiling at the post-move size; it ratchets DOWN as background/preprocessing/upscaling/deblur move out.
    "toolbox/image_processing_tools.py": 2515,
